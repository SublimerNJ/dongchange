...
function share(type) {
	...
	if (type == 'email') {
		$('.ico-sns-email').attr('href', 'mailto:?body=' + encodeUri);
	} else if (type == 'facebook') {
		pop = window.open("https://www.facebook.com/sharer/sharer.php?u=" + encodeUri, '', 'width=' + _width + ', height=' + _height + ', left=' + _left + ', top=' + _top);
	} else if (type == 'linkdin') {
		pop = window.open("http://www.linkedin.com/cws/share?url=" + encodeUri, '', 'width=' + _width + ', height=' + _height + ', left=' + _left + ', top=' + _top);
	} else if (type == 'url') {
		
		CopyUrlToClipboard(siteUrl);

	}
}

//URL 복사
function CopyUrlToClipboard(siteUrl){
	...
	var copyUrl = $('meta[property="og:copyUrl"]').attr('content');
